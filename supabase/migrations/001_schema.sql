...
('anticretico', 'Anticrético', 'Contrato de anticrético sobre inmueble', 900.00, 5, '[{"name":"DNI Propietario","description":"DNI vigente del propietario"},{"name":"DNI Anticresista","description":"DNI vigente del anticresista"},{"name":"Partida Registral","description":"Partida registral del inmueble"},{"name":"HR y PU","description":"Hoja de resumen y predio urbano vigentes"}]')
