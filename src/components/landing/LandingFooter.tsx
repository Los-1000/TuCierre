...
export default function LandingFooter() {
  return (
    <footer
      className="w-full border-t bg-brand-navy-deep"
    ...
    >
      <div className="max-w-screen-xl mx-auto px-6 md:px-10 py-16 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        {COLS.map(col => (
          <div key={col.heading} className="space-y-5">
            <h4 className="font-black uppercase tracking-widest text-xs" style={{ color: 'rgba(255,255,255,0.55)' }}>
              {col.heading}
            </h4>
      ...
      >
        <p className="font-black text-white tracking-tight leading-none" style={{ fontSize: 'clamp(28px, 4vw, 60px)' }}>
          ...
          <span className="font-display italic" style={{ color: 'rgba(255,255,255,0.55)' }}>de los brokers.</span>
        </p>
