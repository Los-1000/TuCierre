export default function FeaturesSection() {
  return (
    <section id="features" className="py-28" style={{ background: '#020952', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
      <div className="max-w-screen-xl mx-auto px-6 md:px-10">
        ...
        <div className="mb-16 flex flex-col lg:flex-row lg:items-end justify-between gap-6">
          ...
          >
            ...
            <span className="font-black font-display italic" style={{ color: '#4D78FF' }}>sin fricciones</span>
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-3">
          ...
          >
            <p className="text-xs font-black uppercase tracking-[0.25em]" style={{ color: 'rgba(255,255,255,0.3)' }}>01</p>
            <div>
              <h3
          ...
          <div
            ...
            style={{ background: 'rgba(255,255,255,0.07)', minHeight: '340px' }}
          >
            <p className="text-xs font-black uppercase tracking-[0.25em]" style={{ color: 'rgba(255,255,255,0.3)' }}>02</p>
          ...
          <div className="md:col-span-3 rounded-2xl overflow-hidden">
            <div className="grid md:grid-cols-[5fr_7fr]" style={{ background: 'rgba(255,255,255,0.07)' }}>
              ...
              >
                <p className="text-xs font-black uppercase tracking-[0.25em]" style={{ color: 'rgba(255,255,255,0.3)' }}>03</p>
                <h3
              ...
              <div className="p-10 md:p-14 flex items-center" style={{ background: '#020952', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
