    ...
    <div className="min-h-screen bg-[#f7fafc]">
      ...
      <header className="bg-white border-b border-navy-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <Logo size="sm" href="/" />
          <Link href="/" className="text-sm text-navy-500 hover:text-navy-900">← Volver al inicio</Link>
        </div>
      </header>

      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        <h1 className="text-3xl font-bold text-navy-900 mb-2">Términos de Uso</h1>
        <p className="text-navy-500 text-sm mb-10">Última actualización: marzo 2025</p>

        <div className="bg-white rounded-2xl border border-navy-200 shadow-sm p-8 space-y-8 text-navy-700 leading-relaxed">

          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-navy-900">1. Aceptación de los términos</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-navy-900">2. Descripción del servicio</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-navy-900">3. Registro de cuenta</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-navy-900">4. Programa de referidos</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-navy-900">5. Sistema de tiers y descuentos</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-navy-900">6. Price Match</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-navy-900">7. Limitación de responsabilidad</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-navy-900">8. Modificaciones</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-navy-900">9. Ley aplicable</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-navy-900">10. Contacto</h2>
            <p>
