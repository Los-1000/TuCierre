      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="bg-white rounded-2xl border border-navy-200 shadow-sm p-8 space-y-8 text-navy-700 leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-navy-900">1. Responsable del tratamiento</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-navy-900">2. Datos que recopilamos</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-navy-900">3. Finalidad del tratamiento</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-navy-900">4. Compartición de datos</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-navy-900">5. Conservación de datos</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-navy-900">6. Tus derechos</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-navy-900">7. Seguridad</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-navy-900">9. Contacto</h2>
            <p>
